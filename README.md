...
## ✨ SVI 2.0 Pro Workflow

Thanks to many enthusiastic community users who keep creating and updating various SVI workflows, we now have a growing collection of different features and use cases. Please refer to the [pinned issue](https://github.com/vita-epfl/Stable-Video-Infinity/issues/51) for a summarized overview of these workflows. We will continuously update that issue to showcase more interesting and useful SVI workflows.

Here are some beautiful videos generated by creative users using SVI 2.0 Pro workflows, big thanks to the community! You’re far better at playing with SVI than we are! Please don’t hesitate to share your SVI creations with us! thank you!
...
<table>
  <tr>
    <td>
      ...
      <p align="center">Big thanks to @PT from a user group.</p>
    </td>
    <td>
      <video src="https://github.com/user-attachments/assets/09e089ba-2d1d-43b1-a3c3-881b4b7587b2"
             controls
             muted
             width="100%">
      </video>
...
<table>
  <tr>
    <td>
      ...
      <p align="center">Big thanks to @Aiwood from a user group.</p>
    </td>
    <td>
    ...
    <td>
      ...
      <p align="center">Big thanks to @CUDA out of memory from a user group.</p>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td>
      ...
      <p align="center">Big thanks to @wallen from a user group.</p>
    </td>
    <td>
